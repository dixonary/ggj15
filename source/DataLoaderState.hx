...
class DataLoaderState extends FlxState {
    ...
    override public function create():Void {
        ...
        var t = new FlxText(0,FlxG.height/2-100, FlxG.width, "loading levels...");
    ...
    public function fail(e):Void {
        var t = new FlxText(0,FlxG.height/2-50, FlxG.width, "An error has occurred");
        t.setFormat(null, 50, 0xffffffff, "center");
        add(t);
        var t = new FlxText(0,FlxG.height/2+20, FlxG.width, "the level data could not be downloaded");
